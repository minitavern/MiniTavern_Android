...
- **オフライン対応**  
  ローカルモデル（Ollama 互換エンドポイント経由）を使用することで、完全にプライベートでインターネット不要なチャットが可能です。
...
Google Play の審査に関する問題が現在も未解決のため、Android クライアントは暫定的に代替チャンネルを通じて配布しています。  
公式バージョンが Google Play 審査を通過して公開された時点で、このサイドロード/配布バージョンは終了します。  
ご理解いただきありがとうございます——Play Store への完全な公開に向けて積極的に取り組んでいます。
